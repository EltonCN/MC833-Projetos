...
const char* password = "konkeriot";

// Dados do servidor MQTT
const char* mqtt_server = "mqtt.prod.konkerlabs.net";

const char* USER = "1034b6g3c0up";
const char* PWD = "cOvFcglH1hE8";

const char* PUB = "data/1034b6g3c0up/pub/temperatura";
const char* SUB = "data/1034b6g3c0up/sub/config";
